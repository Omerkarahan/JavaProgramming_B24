    ...
    public static void main(String[] args) {
        ...
        for(String eachWord : words){
            ...
            for(int i = 0; i < eachWord.length()/2; i++){
                ...
                /*
                the length - 1 -i
                part allows you to read the caharacters from the end in the same number of iterations that i goes forwards
                instead of this approach you could have also made another variable that sytarts from the last index and decrements everytime
